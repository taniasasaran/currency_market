defmodule CurrencyMarketWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CurrencyMarketWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CurrencyMarketWeb.Gettext, "errors", msg, opts)
    end
  end
